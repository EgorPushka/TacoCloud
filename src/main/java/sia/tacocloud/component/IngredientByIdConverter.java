...
public class IngredientByIdConverter implements Converter<String, Ingredient> {
  ...
  //
  //    static {
  //        INGREDIENT_MAP.put("FLTO", new Ingredient("FLTO", "Flour Tortilla",
  // Ingredient.Type.WRAP));
  //        INGREDIENT_MAP.put("COTO", new Ingredient("COTO", "Corn Tortilla",
  // Ingredient.Type.WRAP));
  //        INGREDIENT_MAP.put("GRBF", new Ingredient("GRBF", "Ground Beef",
  // Ingredient.Type.PROTEIN));
  //        INGREDIENT_MAP.put("CARN", new Ingredient("CARN", "Carnitas", Ingredient.Type.PROTEIN));
  //        INGREDIENT_MAP.put("TMTO", new Ingredient("TMTO", "Diced Tomatoes",
  ...
  //        INGREDIENT_MAP.put("JACK", new Ingredient("JACK", "Monterrey Jack",
